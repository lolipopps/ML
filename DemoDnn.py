...
### 会自动根据标签读取个数
mlp = MLPClassifier(hidden_layer_sizes=(120,60), max_iter=1000, alpha=1e-4,
                    solver='adam', verbose=100, tol=1e-7, random_state=1,
...
"""
def getBestPara():
    grid = GridSearchCV(MLPClassifier(), param_grid={"hidden_layer_sizes":[(120,60),(80,20),(100,50,20)],"alpha":[1e-4, 1e-3, 1e-5], "solver": ['sgd', 'adam'],
